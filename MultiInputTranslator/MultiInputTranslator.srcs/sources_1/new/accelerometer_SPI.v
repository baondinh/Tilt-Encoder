`timescale 1ns / 1ps
// Accelerometer SPI by David J. Marrion (FPGADude on GitHub)
// Small portion of code related to accelerometer data output edited for the purposes of the multi-input translator project
// Main edit lines 737-751
